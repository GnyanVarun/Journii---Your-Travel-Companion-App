...
class _EditTripSheetState extends ConsumerState<EditTripSheet> {
  ...
  late TripStyle? _style;

  late int _curiosityLevel;
  ...
  void initState() {
    ...
    _style = widget.trip.style;
    _curiosityLevel = widget.trip.curiosityLevel;
  }
  ...
  Future<void> _pickDate({required bool isStart}) async {
    ...
    final picked = await showDatePicker(
      ...
      // 🟢 FIXED: Themed the calendar dialog to match the dynamic Aqua/Navy logic
  ...
  String _getLabel(int level) {
    switch (level) {
      case 1: return "📸 The Tourist (Must-Sees)";
      case 2: return "🧭 The Explorer (Balanced)";
      case 3: return "🕵️‍♀️ The Insider (Hidden Gems)";
      default: return "";
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: _buildInputDecoration('Trip Title', Icons.edit_rounded, isDark, accentColor),
            ),
            ...
            TextField(
              ...
              maxLines: 2,
              decoration: _buildInputDecoration('Description', Icons.description_outlined, isDark, accentColor),
            ),
            const SizedBox(height: 24),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text("Curiosity Level", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: textColor)),
                    ],
                  ),
                  const SizedBox(height: 6),
                  Text(
                    "How 'hidden' do you want the AI suggestions to be?",
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      inactiveTickMarkColor: isDark ? Colors.white.withOpacity(0.5) : Colors.black.withOpacity(0.5),
                    ),
                    child: Slider(
                      value: _curiosityLevel.toDouble(),
                      min: 1,
                      max: 3,
                      divisions: 2,
                      label: _getLabel(_curiosityLevel),
                      onChanged: (val) {
                        setState(() => _curiosityLevel = val.toInt());
                      },
                    ),
                  ),
                  Center(
                    child: Text(
                      _getLabel(_curiosityLevel),
                      style: TextStyle(
                        color: accentColor,
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Save Changes', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 0.5, color: accentForeground)),
                    ),
                  ),
                ),
              ],
